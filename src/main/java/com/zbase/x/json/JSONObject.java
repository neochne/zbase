...
public class JSONObject {
    ...
    public static JSONObject create(String json) {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("parse fails or doesn't yield a JSONObject");
        }
    }

    public static JSONObject createFromAssetsFile(Context context, String fileName) {
        return create(FileUtils.readTextFromAssetsFile(context, fileName));
    }

    public static JSONObject createFromLocalFile(File file) {
     ...
     */
    @NonNull
    public JSONObject put(String name, @NonNull Object value) {
        nameValuePairs.put(name, value);
        return this;
    }
     ...
     */
    @NonNull
    public JSONObject accumulate(@NonNull String name, @NonNull Object value) throws JSONException {
     ...
     */
    @NonNull
    public JSONObject append(@NonNull String name, @Nullable Object value) throws JSONException {
        Object current = nameValuePairs.get(checkName(name));
    ...
    public float optFloat(String name) {
        Float result = JSON.toFloat(opt(name));
    ...
    public JSONArray optJSONArray(@Nullable String name) {
        Object object = opt(name);
        return object instanceof JSONArray ? (JSONArray) object : JSONArray.create();
    }
    ...
    public JSONObject optJSONObject(@Nullable String name) {
        Object object = opt(name);
        return object instanceof JSONObject ? (JSONObject) object : create();
    }
