...
public class JSONArray {
    ...
    public static JSONArray create(String json) {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("parse fails or doesn't yield a JSONArray");
        }
    }

    public static JSONArray createFromAssetsFile(Context context, String fileName) {
    ...
    public JSONArray optJSONArray(int index) {
        Object object = opt(index);
        return object instanceof JSONArray ? (JSONArray) object : create();
    }
    ...
    public JSONObject optJSONObject(int index) {
        Object object = opt(index);
        return object instanceof JSONObject ? (JSONObject) object : JSONObject.create();
    }
